-- Instagram Automation module (jul 2026)
-- SQL 100% idempotente: se puede aplicar vía `prisma migrate deploy`,
-- vía Supabase SQL Editor (móvil) o vía POST /api/admin/setup-instagram.
